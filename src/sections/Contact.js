    ...
    <section className="container mx-auto flex py-20">
      ...
      <div className="w-1/2">
        ...
        <div className="flex flex-col items-start max-w-md">
          <input className="name border-b-2 pb-1 w-full" placeholder="Name" />
          <input className="email border-b-2 pb-1 my-5 w-full" placeholder="Email" />
          <textarea placeholder="Enter your message" className="border-2 w-full " rows="3"></textarea>
