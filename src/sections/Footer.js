...
const Footer = () => {
  return (
    <section className="w-11/12 w-11/12 max-w-screen-lg mx-auto flex flex-col justify-between text-center items-center pb-6 sm:flex-row sm:text-left sm:pb-10">
