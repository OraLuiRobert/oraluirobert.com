...
const Card = ({ packageName, packagePrice, packageBenefits, index }) => {
  ...
  return (
    <div
      className={`flex flex-col justify-between p-10 rounded-2xl flex-1 mx-5 text-center text-white shadow-2xl bg-gradient-to-br  ${gradientSetings[index].gradientFrom} ${gradientSetings[index].gradientVia} ${gradientSetings[index].gradientTo}`}
    >
